...
<header class="main-header">
    ...
    <main class="content">
        ...
        <form class = "tar-form" action="server/delTar.php" method = "post">
        <p class = "field">
        ...
        <?php
            ...
            $tar = mysqli_query($connection, "SELECT НазваниеТарифа FROM Тариф");

            while (($tariff = mysqli_fetch_assoc($tar))) {
                echo '<option>' . $tariff['НазваниеТарифа'] . '</option>';
            }
            ?>
        </select>
        </p>
